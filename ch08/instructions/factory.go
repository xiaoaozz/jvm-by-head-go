...
import (
	...
	"jvm-by-head-go/ch08/instructions/comparisons"
	"jvm-by-head-go/ch08/instructions/constants"
	"jvm-by-head-go/ch08/instructions/control"
	"jvm-by-head-go/ch08/instructions/conversions"
	"jvm-by-head-go/ch08/instructions/extended"
	"jvm-by-head-go/ch08/instructions/loads"
	"jvm-by-head-go/ch08/instructions/math"
	"jvm-by-head-go/ch08/instructions/references"
	"jvm-by-head-go/ch08/instructions/stack"
	"jvm-by-head-go/ch08/instructions/stores"
)
