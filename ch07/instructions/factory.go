...
import (
	...
	"jvm-by-head-go/ch07/instructions/comparisons"
	"jvm-by-head-go/ch07/instructions/constants"
	"jvm-by-head-go/ch07/instructions/control"
	"jvm-by-head-go/ch07/instructions/conversions"
	"jvm-by-head-go/ch07/instructions/extended"
	"jvm-by-head-go/ch07/instructions/loads"
	"jvm-by-head-go/ch07/instructions/math"
	"jvm-by-head-go/ch07/instructions/references"
	"jvm-by-head-go/ch07/instructions/stack"
	"jvm-by-head-go/ch07/instructions/stores"
)
